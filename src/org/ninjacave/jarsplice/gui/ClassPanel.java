...
public class ClassPanel extends JPanel implements ActionListener
{
	...
	public ClassPanel(JarSpliceFrame jarSplice) {
		...
		// VMBox now visible by default :
		setVMBoxVisible(true);
	...
	public void setMainClass(String mainClass) {
		this.classTextField.setText(mainClass);
	}
	...
	public void setVmArgs(String vmArgs) {
		this.vmTextField.setText(vmArgs);
	}

	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.optionsButton)
			setVMBoxVisible(!vmArgBox.isVisible());
	}

	public void setVMBoxVisible(boolean visible) {
		if (!visible) {
